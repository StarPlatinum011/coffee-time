...
const useUploadthingInputProps = (...args: Input) => {
    ...
    const onChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        console.log(result , " : Uploaded files");
...
export function SimpleUploadButton() {
    ...
    return (
        <div>
            <label htmlFor="upload-btn" className="cursor-pointer"><UploadSVG/></label>
            <input 
                id='upload-btn' 
                type='file' 
                className="sr-only" 
